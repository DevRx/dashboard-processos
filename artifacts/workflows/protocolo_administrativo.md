...
O CRM **não protocola**. Não existe API pública do INSS para terceiros, e o acesso aos sistemas externos exige certificado A3 ICP-Brasil — cuja chave privada não sai do token — ou login gov.br com 2FA. Nenhum servidor consegue autenticar por você.
...
|---|---|---|
| Companion local com certificado A3 | Preenche o requerimento no GERID a partir do CRM | Outro produto, fora deste repositório; frágil a mudança de layout; esbarra no 2FA |
...
- Certificado A3 ICP-Brasil exigido para sistemas externos do INSS desde 30/06/2026
